...
.controller('vnReceptionController', function( 
    ...
    $scope.handleTaskTitleClick = function(){
    	...
    	gaTracker.sendEvent('Hub title clicked', "To Do", 'Tasks');
    };

    $scope.handleAppointmentsTitleClick = function(){
    	vnNavigationFactory.switchScreens( 'VN_APP__DAY' );
    	gaTracker.sendEvent('Hub title clicked', "Appointments", 'Appointments');
    };

    $scope.handleAnnouncementsTitleClick = function(){
    	vnNavigationFactory.switchScreens( 'VN_ANNOUNCEMENTS__HOME' );
    	gaTracker.sendEvent('Hub title clicked', "Announcements", 'Announcements');
    };

    $scope.handleMailTitleClick = function(){
    	vnNavigationFactory.switchScreens( 'VN_MAIL__MAIL_HOME' );
    	gaTracker.sendEvent('Hub title clicked', "Mail", 'Mail');
    };
    ...
    $scope.announcementAddClickHandler = function(){
		...
		gaTracker.sendEvent('Hub Add clicked', "Announcements", 'Announcements');
    };
    ...
    $scope.taskAddClickHandler = function( ){
		...
		gaTracker.sendEvent('Hub Add clicked', "To do", 'Tasks');
