...
.controller('vnTextInputController', function( 
	$scope,
	...
	$scope.clearValidationMessage 	= function(){ 
		console.log( "####Clearing Text input validation" );
		$scope.message = null;
	};
...
.directive('vnTextInput', function() {
    return {
      restrict: 'E',
      scope: {
      	label: '@vnLabel',
      ...
      templateUrl: 'apps/visiondynamo/common/component/textinput/vntextinput.html'
    };
});